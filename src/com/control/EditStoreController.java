...
public class EditStoreController {
	...
	//Constructor
	public EditStoreController(EditStore view, StoreDatabase storeDb) {
		this.view = view;
...
//					ArrayList<Store> deliverymansArray = StoreDatabase.getStoresArray();
//					
//					// loop through the deliveryman array
//					for (Store s : deliverymansArray) {
//						// print out the content of the array
//						System.out.println(s.getAreas() + s.getMondayClose() + s.getSundayOpen());
//					}
